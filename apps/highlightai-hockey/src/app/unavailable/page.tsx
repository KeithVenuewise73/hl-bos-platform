    ...
    <div style={{ maxWidth: 620, margin: "12vh auto" }}>
      ...
      <div className="card">
        ...
        <p className="small muted">
          ...
          deliberately will not start without them: serving video of a child — at a
          named rink, on a known date, beside their name, team and jersey number — to
          anyone who finds the address is worse than not serving at all.
        </p>
      </div>
    </div>
  );
